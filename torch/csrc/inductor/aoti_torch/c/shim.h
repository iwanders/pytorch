...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_new_stable_ivalue(StableIValue** ret_value);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_delete_stable_ivalue(StableIValue* value);
